...
> HTML / CSS & JavaScript capstone project plus Desktop and Mobile version responsive - Conference Page
...
- [Live Demo Link](https://abdullah97-pro.github.io/capstoneModule1/) 
...
```sh
  cd my-folder
  git clone https://github.com/abdullah97-pro/capstoneModule1
```
<!-- INSTALL -->
